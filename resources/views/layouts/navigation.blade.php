<nav x-data="{ open: false }" class="bg-primario-500">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 lg:flex">
                    ...
                    @can('ver-mis-inscripciones')
                    <x-nav-link :href="route('asistente.inscripciones')" :active="request()->routeIs('asistente.inscripciones')" wire:navigate>
            ...
            @guest
            <div class="hidden space-x-2 sm:-my-px sm:ms-10 lg:flex lg:items-center">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="space-y-1 border-t border-primario-400">
            ...
            @can('ver-mis-inscripciones')
                <x-responsive-nav-link :href="route('asistente.inscripciones')" :active="request()->routeIs('asistente.inscripciones')" wire:navigate>
                    {{ __('Mis Inscripciones') }}
                </x-responsive-nav-link>
            @endcan
